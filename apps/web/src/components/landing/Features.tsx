...
export function Features() {
  return (
    <section id="features" className="scroll-mt-24 border-t border-void-line py-24">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <FadeUp>
          <p className="text-sm text-signal">Features</p>
          <h2 className="mt-3 max-w-xl font-display text-4xl tracking-tight text-white sm:text-5xl">
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((feature, index) => (
            <FadeUp key={feature.title} delay={index * 0.04}>
              <article className="h-full border border-void-line bg-void-surface p-6 transition-transform duration-150 hover:-translate-y-1">
